...
distance_weights <- dnearneigh(coords, 0, 5000, longlat = FALSE)
...
## **6.1 Urban Planning Implications**
...
1.  Park, S., Seo, H., & Koo, H. (2023). Exploring the spatio-temporal clusters of closed restaurants after the COVID-19 outbreak in Seoul using relative risk surfaces. *Scientific Reports*, 13, 13889. https://doi.org/10.1038/s41598-023-40937-5

2.  Ben-Said, M. (2021). Spatial point-pattern analysis as a powerful tool in identifying pattern-process relationships in plant ecology: an updated review. *Ecological Processes*, 10, 56. https://doi.org/10.1186/s13717-021-00314-4

3.  Kam, T. S. (2023). R for Geospatial Data Science and Analytics. Retrieved from https://r4gdsa.netlify.app/chap01.html

4.  Accounting and Corporate Regulatory Authority (ACRA). (2024). Information on Corporate Entities. Retrieved from https://data.gov.sg/

5.  Department of Statistics Singapore. (2020). Singapore Standard Industrial Classification (SSIC) 2020. Retrieved from https://www.singstat.gov.sg/
